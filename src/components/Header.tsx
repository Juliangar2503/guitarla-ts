...
type HeaderProps = {
    ...
    changeQuantity: (id: CartItem['id'], quantity: number) => void
    clearCart: () => void
    isEmpty: boolean
    cartTotal: number
}

export default function Header({ cart, removeFromCart, changeQuantity, clearCart, isEmpty, cartTotal }: HeaderProps) {
